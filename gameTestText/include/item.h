...
class weapon : public item
{
	public:
		...
		weapon(std::string, std::string, std::string, int, int, int);
...
class consumable : public item
{
	public:
		...
		consumable(std::string, std::string, std::string, int, int);
...
class buff : public item
{
    public:
        ...
        buff(std::string, std::string, std::string, int, int);
...
class misc : public item
{
	public:
		...
		misc(std::string, std::string, std::string, int);
