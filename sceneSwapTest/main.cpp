/*
    This program implements input actions such as movement and zooming
    into a basic model with lighting
*/
#pragma once
...
char *file1 = "images/2.jpg";
char *file2 = "images/large.png";
char *file3 = "images/Aurora.png";
char *file4 = "images/Eureka.png";
...
{
    Scene->windMsg(hWnd, uMsg, wParam, lParam);     //Keyboard Inputs
